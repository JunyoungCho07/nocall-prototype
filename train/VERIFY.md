...
3. 계산대 위에 제품을 **서로 안 겹치게 한 겹으로** 펼쳐 놓으면 → 보이는 개수만큼 오른쪽 장바구니에 **집계** (제품을 빼면 약 1초 뒤 빠짐)
4. 가격 매핑 정상: 콜라 1,800 / 물 1,000 / 시리얼 6,000 / 종이컵 500 / 컵라면 1,500
...
- [ ] 한 겹으로 펼친 제품 개수가 장바구니에 맞게 집계됨 (제품 빼면 빠짐)
